...
const ABSEW = Language.getString('admincont');
    QueenSew.newcmdaddtosew({pattern: 'tagadmin', fromMe: RS, desc: ABSEW.CONTADMİN}, (async (message, match) => {
        var nwjson = await message.client.groupMetadata(message.jid) 
...
if (Config.WORKTYPE == 'public') {
    QueenSew.newcmdaddtosew({pattern: 'tagadmin', fromMe: true, desc: ABSEW.CONTADMİN, dontAdCommandList: true}, (async (message, match) => {
    var nwjson = await message.client.groupMetadata(message.jid) 
        let grup = await message.client.groupMetadata(message.jid);
        var jids = [];
        mesaj = '';
