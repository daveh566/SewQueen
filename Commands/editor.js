...
const Dsew = Language.getString('deepai'); // Language Support
const Lang = Language.getString('conventer');
var noAPI = ''
if (Raviya.LANG == 'SI') {
...
const BBsew = Language.getString('memes');
const memeMaker = require('meme-maker')
    QueenSew.newcmdaddtosew({pattern: 'meme ?(.*)', fromMe: RS, desc: BBsew.MEMES_DESC}, (async (message, match) => {    
    ...
    QueenSew.newcmdaddtosew({pattern: 'deepai$', fromMe: RS, delownsewcmd: false, desc: Dsew.DEEPAI_DESC}, (async (message, match) => {
const imgthumb = await thumbnail()
...
const imgthumb = await thumbnail()
        if (!Raviya.DEEPAI) return await message.sendMessage(noAPI);
        if (match[1] === '') return await message.sendMessage(Dsew.TEXT);
...
const imgthumb = await thumbnail()
    ...
    QueenSew.newcmdaddtosew({pattern: 'x4mp4', fromMe: RS, dontAdCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {caption: '*' + Raviya.CPK + '*'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
    ...
    QueenSew.newcmdaddtosew({pattern: 'mp4image', fromMe: RS, dontAdCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '*' + Raviya.CPK + '*'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
...
const imgthumb = await thumbnail()
        ...
        ffmpeg(location)
            ...
            .save('output.jpg')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output.jpg'), MessageType.image, {mimetype: Mimetype.jpg, thumbnail: imgthumb, quoted: message.data, caption: '*' + Raviya.CPK + '*'});
        });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
...
const imgthumb = await thumbnail()
    ...
    QueenSew.newcmdaddtosew({pattern: 'gif', fromMe: RS, dontAdCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('output_gif.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('output_gif.mp4'), MessageType.video, {mimetype: Mimetype.gif, caption: '*' + Raviya.CPK + '*'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
...
const Asew = Language.getString('qrgenerator');
QueenSew.newcmdaddtosew({pattern: 'qr ?(.*)', fromMe: RS, desc: Asew.QR_DESC}, (async (message, match) => {
const imgthumb = await thumbnail()
    if (match[1] === '') return await message.sendMessage(Asew.TEXT);

    var webimage = await axios.get(`https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=${match[1].replace(/#/g, '\n')} `, { responseType: 'arraybuffer' })

    await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Raviya.CPK, thumbnail: imgthumb, quoted: message.data })
}));